...
#1. 1Ask a user for the year they were born by calculating their age. Assuming they already had their birthday and it’s 2019 print “You are [AGE] years old”

# ageofuser= int(input("What year were you born"))
# userinput=1972
ageofuser="47" \
          "print (age of user)
...
#              ("Hello Student")
# 3:
# Ask the user for a negative number. Print from 7 down to
# the user's negative number. You must include the user's number.
# userInput= input("Enter a negative number")
# for x in range (7,-6,-1):
#     print(x)
# 4.Ask the user to enter ain number between -10 to -5. If their input is not between the two numbers ask them to do it again until they get it right. Afterward they print the correct number, print "Good job"
[]# while userinput !=(-10 -5):
#     print("Do it again")
# if userinput== "Is the correct number":
#     print("Good job")
5. # Create the list: squad = ["One", "Two", "Three", "Four", "Five"]. Print the list in reverse without using a list method
squad= ["one","two,""three","four","five","six"]
for  x in len(array) (-1,-1,-1):
